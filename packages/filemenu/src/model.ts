 ...
 */
export class FileMenuModel implements IDisposable {
  /**
   * Construct a new file browser model.
   */
  constructor(options: FileMenuModel.IOptions) {
...
/**
 * The namespace for the `FileMenuModel` class statics.
 */
export namespace FileMenuModel {
  /**
