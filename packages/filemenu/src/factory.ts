 ...
 */
export const IFileMenuFactory = new Token<IFileMenuFactory>(
  '@jupyterlab/filebrowser:IFileMenuFactory'
);
/* tslint:enable */
 ...
 */
export interface IFileMenuFactory {
  /**
   ...
   */
  readonly tracker: InstanceTracker<FileMenu>;

  /**
   * The default file browser for the application.
   */
  defaultBrowser: FileMenu;
}

/**
 * A namespace for file browser factory interfaces.
 */
export namespace IFileMenuFactory {
  /**
