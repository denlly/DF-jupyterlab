...
import { FileMenuModel } from './model';
 ...
 */
const FILE_BROWSER_CLASS = 'jp-FileMenu';

/**
 * The class name added to the filemenu crumbs node.
 */
const CRUMBS_CLASS = 'jp-FileMenu-crumbs';

/**
 * The class name added to the filemenu toolbar node.
 */
const TOOLBAR_CLASS = 'jp-FileMenu-toolbar';

/**
 * The class name added to the filemenu listing node.
 */
const LISTING_CLASS = 'jp-FileMenu-listing';
...
export class FileMenu extends Widget {
   ...
   */
  constructor(options: FileMenu.IOptions) {
    super();
   ...
   */
  private _onConnectionFailure(sender: FileMenuModel, args: Error): void {
...
/**
 * The namespace for the `FileMenu` class statics.
 */
